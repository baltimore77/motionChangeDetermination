<script type="text/javascript">let db_connection = false</script>
<!DOCTYPE html>
<html>
  <head>
  ...
  <footer>
    ...
    <script type="text/javascript">
      ...
      if (db_connection === false) {
        ...
        siteNumber = "";
        ageAtAssessment = "";
        feedbackLink = "https://belieflab.yale.edu/omnibus/eCRFs/feedback/tasks/kamin.php?candidateId=&studyId=";
      }
    </script>
  </footer>
</html>
