...
jsPsych.plugins["rdk-change"] = (function () {
    ...
    plugin.info = {
        ...
        parameters: {
            ...
            coherence_duration: {
                ...
                description:
                    "How long the coherent dots flow prior to a change, in the event of a change in coherent direction",
            },
            coherence_change: {
                type: jsPsych.plugins.parameterType.BOOL,
            ...
            change_trial_degrees_changed: {
                ...
                default: 90,
                description:
                    "If a change occured among coherent dots, how many degrees was the change",
            },
            coherent_direction_after_change: {
                ...
                default: 0,
                description:
                    "What direction do the coherent dots flow after a direction change",
            },
            trialType: {
                type: jsPsych.plugins.parameterType.STRING,
            ...
            trialSubType: {
                ...
                default: "NA",
                description:
                    "For no-change trials the sub-type is 'NA'; for change trials it is either 'clockwise' or 'counter-clockwise'",
            },
        },
    };
    ...
    plugin.trial = function (display_element, trial) {
        ...
        trial.aperture_height = assignParameterValue(
        ...
        trial.fixation_cross = assignParameterValue(
        ...
        trial.border_thickness = assignParameterValue(
            trial.border_thickness,
            1
        );
        trial.border_color = assignParameterValue(trial.border_color, "black");

        //Change trial additions:
        trial.coherence_duration = assignParameterValue(
            trial.coherence_duration,
            500
        );
        trial.coherence_change = assignParameterValue(
            trial.coherence_change,
            false
        );
        trial.change_trial_degrees_changed = assignParameterValue(
            trial.change_trial_degrees_changed,
            0
        );
        trial.coherent_direction_after_change = assignParameterValue(
            trial.coherent_direction_after_change,
            0
        );
        ...
        var coherentDirectionAfterChange =
            trial.coherent_direction_after_change; //what the new coherent direction is after a change
		...
		*/
            ...
            if (typeof trial.correct_choice !== "undefined") {
                ...
                if (trial.correct_choice.constructor === Array) {
                    ...
                    if (
                        ...
                        trial.correct_choice = trial.correct_choice.map(
                            function (x) {
                ...
                //Else compare the char with the response key
                    ...
                    if (
                        ...
                        return (
                            response.key ==
                            trial.correct_choice.toUpperCase().charCodeAt(0)
                        );
                    }
        ...
        function setUpMultipleApertures() {
            ...
            changeTrialDegreesChangedArray = setParameter(
                changeTrialDegreesChanged
            ); //number of degrees to change coherence in the case of a change trial
            coherentDirectionAfterChangeArray = setParameter(
                coherentDirectionAfterChange
            ); //what the new coherent direction is after a change
        ...
        function initializeCurrentApertureParameters(
            ...
            fixationCrossHeight =
                fixationCrossHeightArray[currentApertureNumber];
            ...
            changeTrialDegreesChanged =
                changeTrialDegreesChangedArray[currentApertureNumber];
            coherentDirectionAfterChange =
                coherentDirectionAfterChangeArray[currentApertureNumber];
            ...
            //Change trial additions:
            coherentChangedJumpSizeX = calculateChangedCoherentJumpSizeX(
                coherentDirectionAfterChange
            );
            coherentChangedJumpSizeY = calculateChangedCoherentJumpSizeY(
                coherentDirectionAfterChange
            );
            ...
            dotArray2d =
                dotArray3d.length !== 0
                    ? dotArray3d[currentApertureNumber]
                    : undefined;
        ...
        function calculateChangedCoherentJumpSizeX(
            coherentDirectionAfterChange
        ) {
        ...
        function calculateChangedCoherentJumpSizeY(
            coherentDirectionAfterChange
        ) {
            var angleInRadians =
                (-coherentDirectionAfterChange * Math.PI) / 180;
            return moveDistance * Math.sin(angleInRadians);
        }
        ...
        function draw() {
            ...
            if (fixationCross === true) {
                ...
                ctx.moveTo(
                    canvasWidth / 2 - fixationCrossWidth,
                    canvasHeight / 2
                );
                ctx.lineTo(
                    canvasWidth / 2 + fixationCrossWidth,
                ...
                ctx.moveTo(
                    canvasWidth / 2,
                    canvasHeight / 2 - fixationCrossHeight
                );
                ctx.lineTo(
                    canvasWidth / 2,
                    canvasHeight / 2 + fixationCrossHeight
            ...
            if (apertureType == 3 || apertureType == 4) {
				...
				*/
                ...
                var weightOnVerticalEdge =
                    (verticalAxis / (verticalAxis + horizontalAxis)) *
                    weightInXDirection;
                ...
                if (
                    ...
                    (weightOnHorizontalEdge + weightOnVerticalEdge) *
                        Math.random()
                ) {
        ...
        function yValuePositive(x) {
            ...
            return (
                verticalAxis *
                    Math.sqrt(
                        1 - Math.pow(x, 2) / Math.pow(horizontalAxis, 2)
                    ) +
                apertureCenterY
                ...
                //Else continue with another frame request
                    ...
                    if (!timerHasStarted && trial.trial_duration > 0) {
                        ...
                        timeoutID = window.setTimeout(
                            end_trial,
                            trial.trial_duration
                        ); //This timeoutID is then used to cancel the timeout should the subject press a valid key
